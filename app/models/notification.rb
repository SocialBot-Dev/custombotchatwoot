...
class Notification < ApplicationRecord
  ...
  def push_message_title
    ...
    when 'conversation_creation'
      I18n.t('notifications.notification_title.conversation_creation', display_id: primary_actor.display_id, inbox_name: primary_actor.inbox.name, contact_name: secondary_actor.contact.name)
    when 'conversation_assignment'
      I18n.t('notifications.notification_title.conversation_assignment', display_id: primary_actor.display_id, inbox_name: primary_actor.inbox.name, contact_name: secondary_actor.contact.name)
    when 'assigned_conversation_new_message'
      I18n.t(
        ...
        contact_name: secondary_actor.contact.name
      )
