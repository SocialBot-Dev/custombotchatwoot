...
class Notification < ApplicationRecord
  ...
  def push_message_title
    ...
    when 'conversation_creation'
      I18n.t('notifications.notification_title.conversation_creation', display_id: primary_actor.display_id, inbox_name: primary_actor.inbox.name, contact_name: conversation.contact)
    when 'conversation_assignment'
      I18n.t('notifications.notification_title.conversation_assignment', display_id: primary_actor.display_id, inbox_name: primary_actor.inbox.name, contact_name: conversation.contact)
