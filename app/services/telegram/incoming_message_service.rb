...
class Telegram::IncomingMessageService
  ...
  def file_content_type
    return :image if params[:message][:photo].present? || params[:message][:sticker].present?
  ...
  def file
    @file ||= params[:message][:photo].presence&.last || params[:message][:sticker].presence || params[:message][:voice].presence || params[:message][:audio].presence ||
